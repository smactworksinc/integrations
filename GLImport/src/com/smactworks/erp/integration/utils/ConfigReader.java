...
public class ConfigReader {
  ...
  public String getArchiveFilePath() {
    return this.properties.getProperty("archiveFilePath");
  }
  ...
  public boolean isUsePSScript() {
    return (this.properties.getProperty("usePSEmailScript") != null && 
      this.properties.getProperty("usePSEmailScript").equalsIgnoreCase("yes"));
  }
  
  public String getPSScriptLoc() {
    return this.properties.getProperty("psScriptLoc");
  }
}
